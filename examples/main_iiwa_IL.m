...
%% (2A) Imitation Learning #2 Orientation 
...
for k = 1 : 3
    ...
    for i = 1: N
        ...
        for j = 1 : P
            ...
            f_arr( j ) = tau * ddy_des( k ) + alpha_z * dy_des( k )+ alpha_z * beta_z * vec1( k );
...
hold on
plot( t_arr2( 1:end-1 ), quat_data_arr );
plot( t_arr2( 1:end-1 ), quat , 'linestyle', '--');
